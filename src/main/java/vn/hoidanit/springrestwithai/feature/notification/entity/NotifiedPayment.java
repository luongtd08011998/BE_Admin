...
/**
 * Bảng theo dõi những hóa đơn đã được gửi push notification khi thanh toán thành công.
 * Mục đích: tránh gửi trùng thông báo khi Cron Job chạy nhiều lần.
 * Nằm ở DB primary (hr_management).
 */
@Entity
@Table(
        name = "notified_payment",
        uniqueConstraints = @UniqueConstraint(
                name = "uk_notified_payment_invoice_id",
                columnNames = {"month_invoice_id"}
        )
)
public class NotifiedPayment {

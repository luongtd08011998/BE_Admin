...
import vn.hoidanit.springrestwithai.qlkh.road.entity.SupportingTable;
...
public interface SupportingTableRepository extends JpaRepository<SupportingTable, Integer> {
    ...
    @Query("SELECT new vn.hoidanit.springrestwithai.qlkh.road.dto.RoadDropdownResponse(s.supportingTableId, s.name, s.type) " +
